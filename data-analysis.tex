...
\item \emph{Validation of a simulation model.} A simulation model of a
  ...
  results for the average number of (simulated) jobs in the shop for 30 independent replications of the simulation model, each for 30 days of simulated time.
