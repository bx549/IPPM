...
\item Determine the probability that there will be exactly 5
  hailstorms at the dealership in June. \label{a}
\item During a hailstorm, determine the probability that 170 or more
  cars will be damaged. \label{b}
\end{enumerate}

\begin{solution}
  \bs For part~\ref{a}, let $X$ be a random variable that represents
...
\]
For part~\ref{b}, the rate that cars are damaged is Poisson with a mean
