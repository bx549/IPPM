...
% this problem is OK
% a poisson process, memoryless property of exponential distribution
...
\item It takes the dump truck 18 minutes to travel to the railroad,
  ...
  scoop is ready within 5 minutes? \label{item:truck}
\end{enumerate}
...
\]
For part~\label{item:truck}, we can invoke the memoryless property of the
