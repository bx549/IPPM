...
\item \emph{Modeling with binary variables.} Consider the scenario: A business sells video games and movies. For each video game sold, the business earns a profit of \$1. For each movie sold, the business earns a profit of \$2. To make inventory management easier, the business has imposed the following restrictions on what customers can purchase.

\begin{compactenum}[i)]
	\item There is a limit of eight items per customer.
	\item A customer can only buy one, four, or six video games. However, any quantity of movies can be purchased. 
	\item A customer cannot purchase five or more video games than movies, and they cannot purchase three or more movies than video games.
\end{compactenum}

The manager would like to determine the combination of purchases by a customer that would maximize profit. The problem can be formulated as follows:
