...
\item \emph{A two-person zero-sum game.}
  ...
  \begin{solution}
  	...
  	\begin{tabularx}{4in}{YYYYY}
  		...
  		\multirow{2}{.5in}{Player} & \gtcol{play} & \gtcol{2} & \gtcol{0} & \gtcol{1} \\ \cline{3-5}
  	...
  	\begin{tabularx}{4in}{YYYY}
  		...
  		& & {don't negotiate} & {double salary} \\ \cline{3-4}
  		\multirow{2}{.5in}{Player} & \gtcol{play} & \gtcol{0} & \gtcol{1} \\ \cline{3-4}
  		& \gtcol{don't play} & \gtcol{-1} & \gtcol{-2} \\ \cline{3-4}
  	\end{tabularx}
  	\vspace{.1in}
  	\endgroup
