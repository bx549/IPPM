...
\item \emph{The lost dog and the value of perfect information.} Oscar
  is walking his dog Pablo down a road. On one side of the road is
  forest A and on the other side of the road is forest B. Pablo
  wanders off into one the forests, but Oscar was preoccupied with his
  cell phone and doesn't know which one. If Pablo is in forest A,
  Oscar's probability of finding him by the end of the day is 0.5. If
  Pablo is in forest B, Oscar's probability of finding him by the end
  of the day is .8. Oscar's prior probability for the dog being in
  forest A is 0.7 (Oscar knows Pablo likes forest A a little better).
