...
helpful robots available. Robot A can move around and collect
items in the warehouse. Robot B seals boxes and puts shipping
labels on them. Robot A costs \$0.50
and Robot B costs \$0.25.
The business has \$1.25 available to spend and they value money. 
...
Robot A gives them a value of \$0.60, the third \$0.30 and so on).
Similarly, the payoff they get from acquiring their first Robot B is
\$0.40 and that of each additional Robot B is half the previous one
(\$0.20, \$0.10, \ldots). The value from each Robot A acquired is not
...
Robot B, you will spend \$.75 and the payoff is
