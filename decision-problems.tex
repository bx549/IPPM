...
% it is a game against nature. the main idea is to have practice with:
% 1. formulation of a decision problem and making a decision based on expected value,
% 2. using Baye's formula to update a prior probability, and 
% 3. computing the value of perfect information.
