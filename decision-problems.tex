...
\item \emph {Decisions under risk and sensitivity analysis.}  The
  ...
  facility in order to meet the predicted increase in demand. The
  facility will cost \$\num{500000} to build. If the demand doubles as
  predicted, their income will increase by \$\num{800000}.  If the demand
  only slightly increases, their income will increase by \$\num{250000}.
  If the facility is not built, the company will lose \$\num{50000} because
  ...
  will be determined by next year's weather; more people want
  to buy outdoor furniture if the weather is nice.
  There is a 0.55 chance of good weather, which will result
  in a doubling of sales. There is a 0.45 chance of poor weather, which
  will result in only a slight increase in sales.

\begin{enumerate}
\item Should the facility by built? Use expected value to make your decision.
\item How does the decision change with the probability of good/poor
weather? To answer this question, you should perform a sensitivity analysis.
\end{enumerate}
