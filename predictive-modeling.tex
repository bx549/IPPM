...
\item \emph{Cherry trees.} There is a dataset in the \texttt{datasets}
	package in R called \texttt{trees} which contains measurements of the girth (diameter) in inches,
	height in feet, and volume in cubic feet of 31 black cherry trees.
\begin{enumerate}
